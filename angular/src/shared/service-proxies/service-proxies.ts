...
export class AccountServiceProxy {
    ...
    sendEmailConfirmation(token: string | null | undefined, userId: number | undefined, mail: string | null | undefined): Observable<void> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSendEmailConfirmation(<any>response_);
                } catch (e) {
    ...
    protected processSendEmailConfirmation(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    checkUserEmailConfirmation(userMailOrName: string | null | undefined): Observable<boolean> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCheckUserEmailConfirmation(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCheckUserEmailConfirmation(<any>response_);
                } catch (e) {
    ...
    protected processCheckUserEmailConfirmation(response: HttpResponseBase): Observable<boolean> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    confirmEmail(token: string | null | undefined, userId: number | undefined): Observable<EmailConfirmationResult> {
        let url_ = this.baseUrl + "/api/services/app/Account/ConfirmEmail?";
        if (token !== undefined && token !== null)
            url_ += "token=" + encodeURIComponent("" + token) + "&";
        if (userId === null)
            throw new Error("The parameter 'userId' cannot be null.");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<EmailConfirmationResult>><any>_observableThrow(e);
                }
            } else
                return <Observable<EmailConfirmationResult>><any>_observableThrow(response_);
        }));
    }

    protected processConfirmEmail(response: HttpResponseBase): Observable<EmailConfirmationResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = EmailConfirmationResult.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<EmailConfirmationResult>(<any>null);
    }
...
export class FormServiceProxy {
     ...
     * @return Success
     */
    createForm(body: FormDto | undefined): Observable<FormDto> {
    ...
    protected processCreateForm(response: HttpResponseBase): Observable<FormDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    updateForm(body: FormDto | undefined): Observable<FormDto> {
    ...
    protected processUpdateForm(response: HttpResponseBase): Observable<FormDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    /**
     * @param dateValue (optional) 
     * @return Success
     */
    checkApplicationStartEndDate(dateValue: moment.Moment | undefined): Observable<boolean> {
        let url_ = this.baseUrl + "/api/services/app/Form/CheckApplicationStartEndDate?";
        if (dateValue === null)
            throw new Error("The parameter 'dateValue' cannot be null.");
        else if (dateValue !== undefined)
            url_ += "dateValue=" + encodeURIComponent(dateValue ? "" + dateValue.toJSON() : "") + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCheckApplicationStartEndDate(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCheckApplicationStartEndDate(<any>response_);
                } catch (e) {
                    return <Observable<boolean>><any>_observableThrow(e);
                }
            } else
    ...
    protected processCheckApplicationStartEndDate(response: HttpResponseBase): Observable<boolean> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getStudentBirthDateMinMax(): Observable<string> {
        let url_ = this.baseUrl + "/api/services/app/Form/GetStudentBirthDateMinMax";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetStudentBirthDateMinMax(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetStudentBirthDateMinMax(<any>response_);
                } catch (e) {
    ...
    protected processGetStudentBirthDateMinMax(response: HttpResponseBase): Observable<string> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    checkStudentBirthDate(dateValue: moment.Moment | undefined): Observable<boolean> {
        let url_ = this.baseUrl + "/api/services/app/Form/CheckStudentBirthDate?";
        if (dateValue === null)
            throw new Error("The parameter 'dateValue' cannot be null.");
        else if (dateValue !== undefined)
            url_ += "dateValue=" + encodeURIComponent(dateValue ? "" + dateValue.toJSON() : "") + "&";
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCheckStudentBirthDate(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCheckStudentBirthDate(<any>response_);
                } catch (e) {
                    return <Observable<boolean>><any>_observableThrow(e);
                }
            } else
    ...
    protected processCheckStudentBirthDate(response: HttpResponseBase): Observable<boolean> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    checkUserApplication(): Observable<number> {
        let url_ = this.baseUrl + "/api/services/app/Form/CheckUserApplication";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCheckUserApplication(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCheckUserApplication(<any>response_);
                } catch (e) {
    ...
    protected processCheckUserApplication(response: HttpResponseBase): Observable<number> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getForm(id: number | null | undefined): Observable<ViewFormDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ViewFormDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<ViewFormDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetForm(response: HttpResponseBase): Observable<ViewFormDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ViewFormDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ViewFormDto>(<any>null);
    }
    ...
    changeLanguage(body: ChangeUserLanguageDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Form/ChangeLanguage";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    get(id: number | undefined): Observable<FormDto> {
        let url_ = this.baseUrl + "/api/services/app/Form/Get?";
        if (id === null)
     ...
     * @return Success
     */
    getAll(sorting: string | null | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<FormDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Form/GetAll?";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<FormDtoPagedResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<FormDtoPagedResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<FormDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = FormDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<FormDtoPagedResultDto>(<any>null);
    }
    ...
    create(body: FormDto | undefined): Observable<FormDto> {
        let url_ = this.baseUrl + "/api/services/app/Form/Create";
        url_ = url_.replace(/[?&]$/, "");
    ...
    update(body: FormDto | undefined): Observable<FormDto> {
        let url_ = this.baseUrl + "/api/services/app/Form/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    delete(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Form/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
...
export class EmailConfirmationResult implements IEmailConfirmationResult {
    canLogin: boolean;
    userInfo: User;

    constructor(data?: IEmailConfirmationResult) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.userInfo = _data["userInfo"] ? User.fromJS(_data["userInfo"]) : <any>undefined;
        }
    }

    static fromJS(data: any): EmailConfirmationResult {
        data = typeof data === 'object' ? data : {};
        let result = new EmailConfirmationResult();
        result.init(data);
        return result;
    }
...
export interface IEmailConfirmationResult {
    canLogin: boolean;
    userInfo: User;
}
...
export class FormDto implements IFormDto {
    studentName: string | undefined;
    studentNameAr: string | undefined;
    studentBirthDate: moment.Moment;
    studentReligion: string | undefined;
    fatherJob: string | undefined;
    motherJob: string | undefined;
    fatherMobile: string | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            this.studentName = _data["studentName"];
            this.studentNameAr = _data["studentNameAr"];
            this.studentBirthDate = _data["studentBirthDate"] ? moment(_data["studentBirthDate"].toString()) : <any>undefined;
            this.studentReligion = _data["studentReligion"];
            this.fatherJob = _data["fatherJob"];
            this.motherJob = _data["motherJob"];
            this.fatherMobile = _data["fatherMobile"];
    ...
    toJSON(data?: any) {
        ...
        data["studentName"] = this.studentName;
        data["studentNameAr"] = this.studentNameAr;
        data["studentBirthDate"] = this.studentBirthDate ? this.studentBirthDate.toISOString() : <any>undefined;
...
export class ViewFormDto implements IViewFormDto {
    form: FormDto;
    dateName: string | undefined;
    timeName: string | undefined;
    ...
    static fromJS(data: any): ViewFormDto {
        data = typeof data === 'object' ? data : {};
        let result = new ViewFormDto();
        result.init(data);
        return result;
    }
...
export class FormDtoPagedResultDto implements IFormDtoPagedResultDto {
    totalCount: number;
    items: FormDto[] | undefined;

    constructor(data?: IFormDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): FormDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new FormDtoPagedResultDto();
        result.init(data);
        return result;
    }
...
export interface IFormDtoPagedResultDto {
    totalCount: number;
    items: FormDto[] | undefined;
}
